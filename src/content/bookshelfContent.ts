      ...
      items: [
        {
          ...
          notes: "This article came out in 2018, but it changed the way I thought about wealth in America and I think about it all the time. Read the article in the Atlantic [here](https://www.theatlantic.com/magazine/archive/2018/06/the-birth-of-a-new-american-aristocracy/559130/) if you're part of the 9.9% and have a subscription, otherwise you can read the pdf version [here](https://longevity.stanford.edu/wp-content/uploads/sites/24/2018/09/The-Birth-of-the-New-American-Aristocracy-The-Atlantic-.pdf)",
        },
        {
          title: "Love is to be invested in someone's continual expansion",
          creator: "Henrik Karlsson",
          imageSrc: "/images/bookshelf/henrik.png",
          notes: "What happens when the person you love changes into someone different from the person they were when you fell in love with them? Henrik Karlsson is the most logical romantic I've ever read. Read it [here](https://www.henrikkarlsson.xyz/p/love-and-change)",
        },
      ],
    },
    {
